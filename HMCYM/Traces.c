...
/*
 * compute various correlation functions and save result in file *outTraces
 */
...
int Traces(doublecomplex **pmat, int size, int nummat, int loopnumber, char *pathout)
{
	int i;
	static int init=0;
	static doublecomplex *pmatX2, *pmatY2, *pmatZ2, *pmatX4, *pmatY4, *pmatX6, *pmatY6, *pmatX8, *pmatY8;
	...
	double trX2=0, trXi2=0, trXY=0, trX2Y2=0, trXYXY=0, trX2Y=0, trX2Y2Z2=0, trX2Y4Z2=0, trX4Y2Z2=0, trX4Y4Z2=0, trX6Y2Z2=0, trX6Y4Z2=0, trX6Y6Z2=0;
	double trX8Y2Z2=0, trX8Y4Z2=0, trX8Y6Z2=0, trX8Y8Z2=0;

	if(init==0)
	{
		pmatX2 = (doublecomplex*) malloc(sizeof(doublecomplex)*size*size);
		pmatY2 = (doublecomplex*) malloc(sizeof(doublecomplex)*size*size);
		pmatZ2 = (doublecomplex*) malloc(sizeof(doublecomplex)*size*size);
...
//		pmatX4Y4 = (doublecomplex*) malloc(sizeof(doublecomplex)*size*size);
	...
	memset(pmatZ2, 0, sizeof(doublecomplex)*size*size);
...
//	memset(pmatX4Y4, 0, sizeof(doublecomplex)*size*size);
	...
	Multi5(pmatZ2, pmat[2], pmat[2], size, 1.0);
...
//	diagMulti(&trX2Y2Z2, pmatX2Y2, pmatZ2, size, 1.0);
//	diagMulti(&trX4Y2Z2, pmatX4Y2, pmatZ2, size, 1.0);
//	diagMulti(&trX4Y4Z2, pmatX4Y4, pmatZ2, size, 1.0);
	diagMulti(&trX6Y2Z2, pmatX6Y2, pmatZ2, size, 1.0);
	diagMulti(&trX6Y4Z2, pmatX6Y4, pmatZ2, size, 1.0);
	diagMulti(&trX6Y6Z2, pmatX6Y6, pmatZ2, size, 1.0);
	diagMulti(&trX8Y2Z2, pmatX8Y2, pmatZ2, size, 1.0);
	diagMulti(&trX8Y4Z2, pmatX8Y4, pmatZ2, size, 1.0);
	diagMulti(&trX8Y6Z2, pmatX8Y6, pmatZ2, size, 1.0);
	diagMulti(&trX8Y8Z2, pmatX8Y8, pmatZ2, size, 1.0);

//	fprintf(outTraces, "%f\t%f\t%f\t%f\n",  trX2/size, trXi2/size, trXY/size, trXYXY/size, trX2Y2/size, trX2Y/size);
//	fprintf(outTraces, "%f\t%f\t%f\t%f\n",  trX2Y2Z2/size, trX2Y4Z2/size, trX4Y2Z2/size, trX4Y4Z2/size);

	fprintf(outTraces, "%f\t%f\t%f\t%f\t%f\t%f\t%f\n",  trX6Y2Z2/size, trX6Y4Z2/size, trX6Y6Z2/size, trX8Y2Z2/size, trX8Y4Z2/size, trX8Y6Z2/size, trX8Y8Z2/size);
	fflush(outTraces);
