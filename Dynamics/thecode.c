...
/*
 * structure constant f_{abc} of SU(3) for queries of individual matrix;
 * mat ... matrix number of first matrix in entry of structure constant
 */
int thecode(int mat, double *mat_c)
{
	if(mat==0)			//labels different matrices in the array
	{
		...
		mat_c[2]=1.0;		// actual value of structure constant
		mat_c[3]=0;
		mat_c[4]=2;
		mat_c[5]=1;
